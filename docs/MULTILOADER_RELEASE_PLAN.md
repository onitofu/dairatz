...
- Первый multi-loader релиз: `1.1.1` для Minecraft `1.21.11`, без нового контента.
...
Тег `v1.1` не переписывается. `1.1.1` является техническим релизом совместимости:
игровое поведение, registry ID, конфигурация и набор контента должны соответствовать
`1.1.0`.
...
Forge и NeoForge, не добавляя новый игровой контент.
